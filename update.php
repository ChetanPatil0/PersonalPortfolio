...
<head>
    ...
    <style>
        ...
        .TitleLabel,.DescriptionLabel,.TechStackLabel,.CodeLinkLabel,.ProjectIOLinkLabel{
            display:none;
        }
        ...
        <form action="update.php" method="Post" class="ProjectAddForm">
            ...
            <div class="FormFields">
             <label for="updatetype" style="text-align:center">What You Want To Update</label><br>
                ...
                <input type="checkbox" name="updatetype"  value="Title" id="Box1" ><label for="updatetype">Title</label>
                <input type="checkbox" name="updatetype" value="Description" id="Box2"><label for="updatetype">Description</label>
                <input type="checkbox" name="updatetype" value="TechStack" id="Box3" ><label for="updatetype">TechStack</label><br>
                <input type="checkbox" name="updatetype" value="CodeLink" id="Box4" ><label for="updatetype">CodeLink</label>
                <input type="checkbox" name="updatetype" value="ProjectIOLink" id="Box5" ><label for="updatetype">OutputLink</label>
                </div>
